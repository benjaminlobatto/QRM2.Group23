...
3. How many subjects?
   There are 707 subjects, we tested for uniqueness and there were no duplicates.

4. What consists of a subject?
   A subject is a single movie. Each row in the dataset represents one movie, described by variables such as: title, budget, revenue, runtime, genre.
